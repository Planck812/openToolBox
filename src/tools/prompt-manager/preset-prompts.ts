...
/**
 * 内置经典提示词，源码级预置：
 * 收录自「数字生命卡兹克」的文章《都 Agent 时代了，我还是想分享给你这 12 个我最常用的 Prompt》，
 * 原文：https://x.com/Khazix0918/article/2090726395035156964
 *
 * 这些提示词按原文完整收录、未做改写；新用户开箱即可见。
 * 用户可以删除它们（删除记录持久化在本地 store 中，不会复活），但内容本身保存在源码里。
 */
export const PRESET_SOURCE_URL = 'https://x.com/Khazix0918/article/2090726395035156964';
...
const PRESET_DEFINITIONS: PresetDefinition[] = [
  {
    id: 'preset-socratic-questioning',
    title: '苏格拉底式提问',
    tags: ['问清问题'],
    content: `我的困惑是：【尽量具体地描述发生了什么、你怎么理解，以及你卡在哪里】。
...
等我确认这个新问题以后，再给出你的判断、理由和下一步行动。`,
  ...
  {
    id: 'preset-dual-layer-explanation',
    title: '双层解释法',
    tags: ['学习'],
    content: `我想学习的是：【填写概念或问题】。
...
3. 3个用于检查我是否真正理解的问题。`,
  ...
  {
    id: 'preset-reverse-deconstruction',
    title: '反向拆解',
    tags: ['学习'],
    content: `我想拆解的优秀范例是：【粘贴产品页面、网页、方案、流程说明、数据看板或其他成品】。
我想学会的是：【填写你希望从中学会什么】。
...
3. 一个最值得先尝试的小练习。`,
  ...
  {
    id: 'preset-horizontal-vertical-analysis',
    title: '横纵分析法',
    tags: ['学习'],
    content: `研究对象是：【填写产品、公司、人物、技术、行业或事件】。
...
最后按以下顺序输出：核心结论、关键时间线、横向对比表、详细分析、未来判断、仍待确认的问题。报告需要在10000～30000字之间，语言尽量通俗，不要堆砌资料。`,
  ...
  {
    id: 'preset-fact-checking',
    title: '事实核查',
    tags: ['学习'],
    content: `我要核查的说法是：【粘贴观点、结论、数据或方案】。
...
4. 我目前可以相信到什么程度。`,
  ...
  {
    id: 'preset-expert-consultation',
    title: '专家会诊',
    tags: ['解决问题'],
    content: `我的问题是：【填写问题、已知事实、目标和现实约束】。
...
不要选择三个高度相似的身份，也不要模仿或编造真实人物的观点。信息不足时，先只问我一个最关键的问题。`,
  ...
  {
    id: 'preset-first-principles',
    title: '第一性原理',
    tags: ['解决问题'],
    content: `我想解决的问题是：【填写你的问题】。
...
4. 验证它的第一步。`,
  ...
  {
    id: 'preset-cross-domain-borrowing',
    title: '跨领域借解',
    tags: ['解决问题'],
    content: `我的困惑是：【说明背景、当前做法、现实约束和具体卡点】。
...
然后从历史案例，以及至少3个彼此距离较远的领域中，各找一个案例。
...
最后请选出最值得借用的3种机制，把它们翻译成适合我当前处境的解决方案，再推荐一个最值得先试的低成本、可逆实验。`,
  ...
  {
    id: 'preset-steelman-both-sides',
    title: '双向钢人论证',
    tags: ['决策'],
    content: `我需要做的决定是：【写清问题、两个选项、目标和现实约束】。
...
等我回答以后，再给出明确判断、理由、适用条件和下一步行动。`,
  ...
  {
    id: 'preset-minimum-viable-experiment',
    title: '用最小实验替代空想',
    tags: ['决策'],
    content: `我正在纠结的是：【填写你的选择或想法】。
...
// 内置提示词的固定时间戳（收录日期），保证排序稳定。
const PRESET_TIMESTAMP = '2026-08-21T00:00:00.000Z';

export const presetPrompts: PromptItem[] = PRESET_DEFINITIONS.map((definition) => ({
  id: definition.id,
  title: definition.title,
  content: definition.content,
  tags: definition.tags,
  sourceUrl: PRESET_SOURCE_URL,
  pinned: false,
  preset: true,
